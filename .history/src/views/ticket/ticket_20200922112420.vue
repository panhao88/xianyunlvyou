          ...
          <div class="box3a p-r">
            ...
            <div class="d-f a-c j-c-a f-d-c " style="width:100%;height:400px;">
              <div class="d-f a-c f-c-hei">
                出发城市：
                <div>
                  <a-input placeholder="请搜索出发城市" style="width:300px;height:40px" v-model:value="chufa"  @change="didi"/>
                </div>
              </div>
              <div class="d-f a-c f-c-hei">
                到达城市：
                <a-input placeholder="请搜索出发城市" v-model:value="daoda"  @change="gege" style="width:300px;height:40px" />
              </div>
              <div class="d-f a-c f-c-hei">
                出发时间：
                <a-date-picker @change="onChange" style="width:300px;" placeholder="请选择日期" format="YYYY-MM-DD HH:mm:ss" v-model:value="day"/>
              </div>
              <div>
  ...
  setup(props, ctx: SetupContext) {
    ...
    const search =() :void => {
      console.log(data.chufa ,"出发")
       console.log(data.daoda,"dao")
        console.log(data.chufa1)
         console.log(data.daoda1)
    }
    const didi = ():void => {
       //机票出发
       const php = data.chufa
        api.getairscity1({name:php}).then((res:any) => {
          if(res.data.length !== ''){
