    ...
    <div class="box2">
      ...
      <div v-if="didi === 1">
        ...
        >
          ...
          <a-form-item ref="name" name="code">
            <a-input v-model:value="ruleForm.code" placeholder="验证码" style="width:380px" />
            <a-button>发送验证码</a-button>
          </a-form-item>
          <a-form-item ref="nickname" name="nickname">
            <a-input v-model:value="ruleForm.nickname" placeholder="请输入昵称" />
          </a-form-item>
           <a-form-item ref="password" name="nickname">
            <a-input v-model:value="ruleForm.nickname" placeholder="请输入密码" />
          </a-form-item>
          <a-form-item :wrapper-col="{ span: 14, offset: 4 }">
