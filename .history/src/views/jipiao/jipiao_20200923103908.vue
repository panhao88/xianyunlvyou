          ...
          <div class="d-f j-c-b m-t-2">
            ...
            <div>
              <a-select
                ...
                placeholder="起飞机场"
              >
                <a-select-option v-for="(item,index) in options.airport " :key="index" style="">{{item}}</a-select-option>
              </a-select>
            </div>
            <div>
              <a-select
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    // const handleChange1 = (value1:any):void => {
    //   const didi1 = data.flights
    //   const didi2 = []
    //   console.log(data.didi1,"didi1")
    //   didi1.map(item => {
