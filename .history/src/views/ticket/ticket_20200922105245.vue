          ...
          <div class="box3a p-r">
            ...
            <div class="d-f a-c j-c-a f-d-c " style="width:100%;height:400px;">
              <div class="d-f a-c f-c-hei">
                出发城市：
                <div>
                  <a-input placeholder="请搜索出发城市" style="width:300px;height:40px" v-model:value="chufa"  @change="Starting"/>
                </div>
              </div>
              <div class="d-f a-c f-c-hei">
                到达城市：
                <a-input placeholder="请搜索出发城市" v-model:value="daoda"  @change="Starting" style="width:300px;height:40px" />
              </div>
              <div class="d-f a-c f-c-hei">
                出发时间：
