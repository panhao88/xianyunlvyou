<template>
  <div class="box1">
    ...
    :model="form"
          :rules="rules1"
        >
          <a-form-item ref=""  name="username" :wrapper-col="wrapperCol">
            <a-input v-model:value="form.username" type="username" placeholder="请输入用户名手机" />
          </a-form-item>
          <a-form-item required has-feedback  name="password">
            <a-input v-model:value="ruleForm1.password" type="password" placeholder="请输入密码" />
          </a-form-item>
