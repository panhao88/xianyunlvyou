        ...
        <div class="box3">
          <div class="box3a">
            <div class="f-c-hong d-f " style="">
              <div class="d-f j-c a-c" style="width:250px;height:60px;background:#fff;border-top: solid 2px  orange;">
            ...
            <div>
              <div>出发城市：<a-input v-model:value="value" placeholder="Basic usage" /></div>
              <div>到达城市<a-input v-model:value="value" placeholder="Basic usage" /></div>
              <div><a-date-picker v-model:value="value1" @change="onChange" /></div>
            </div>
          </div>
          <div class="box3b">
