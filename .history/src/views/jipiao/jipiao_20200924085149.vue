          ...
          <div class="d-f j-c-b m-t-2">
            ...
            <div>
              <a-select
                ...
                placeholder="航空公司"
              >
                <a-select-option :value="item" v-for="(item,index) in options.company" :key="index" @click="handleChange3(item)">{{item}}</a-select-option>
              </a-select>
            </div>
            <div>
              <a-select
                ...
                placeholder="机型"
              >
                <a-select-option :value="item.size" v-for="(item,index) in jixing" :key="index" @click="handleChange4(item.size)">{{item.didi}}</a-select-option>
              </a-select>
            </div>
          </div>
