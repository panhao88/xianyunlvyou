<template>
  <div class="box1">
    ...
    <div class="box2">
      ...
      <div v-if="didi === 0">
        <div> <a-input v-model:value="value" placeholder="Basic usage" /></div>
          <div><a-input-password v-model:value="value" placeholder="input password" /></div>
          <div>忘记密码</div>
          <div><a-button type="primary"></div>
    Primary
  </a-button>
      </div>
    </div>
