    ...
    <div class="box1">
      <div class="box2">
        <div style="width:1050px;">
          ...
          <div class="m-t-2">
            <div class="b-r" v-for="(item,index) in flights.slice((current-1)*pageSize,current*pageSize)" :key="index" style="margin-top:8px" @click="dianji(index)">
              <div class="d-f a-c j-c-a">
                <div>{{item.airline_name}}{{item.flight_no}}</div>
                <div style="width:350px" class="d-f j-c-b">
            ...
            <div v-if="data.flag === index" class="f-c-hei">
              31232132
            </div>
          </div>
        </div>
