    ...
    <div class="box1">
      <div class="box2">
        <div style="width:1050px;">
          ...
          <div class="m-t-2">
            <div class="b-r" v-for="(item,index) in flights.splice((current-1)*pageSize,,current*pageSize)" :key="index" style="margin-top:8px">
              <div class="d-f a-c j-c-a">
                ...
                <div v-for="(item,index) in item.seat_infos.splice(0,1)" :key="index">
                  <div class="d-f a-c">
                    $
                    <div style="color:orange;font-size: 30px;">{{item.settle_price_child}}</div>起
                  </div>
                </div>
              </div>
            </div>
