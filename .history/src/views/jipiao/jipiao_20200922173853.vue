          ...
          <div class="m-t-2">
            ...
            >
              ...
              <div v-if="flag === index" class="f-c-hei">
                <div class="d-f j-c-a a-c">
                  <div style="width:100px">低价推荐</div>
                  <div class="d-f f-d-c j-c-a" >
                    <div v-for="(item2,index2) in item.seat_infos" :key="index2">
                    <div class="d-f j-c-a " style="width:900px">
                      <div style="font-size:15px;width:400px;background:red" class="d-f j-c">{{item2.group_name}} | {{item2.supplierName}}</div>
                      <div style="width:80px;background:red" class="d-f j-c">￥{{item2.settle_price_coupon}}</div>
                      <div style="width:80px;background:red" class="d-f j-c">{{item2.discount}}</div>
                    </div>
                  </div>
                  </div>
                </div>
