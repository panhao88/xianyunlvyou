          ...
          <div class="boto">
            <div>
              <div v-for="(item,index) in posts.slice(0,3)" :key="index">
                <div class="bott"></div>
                <div class="f-s f-c-hei">{{item.title}}</div>
                <div class="bott1 f-c-hei">{{item.summary}}</div>
                <div class="d-f">
                  <div v-for="(item1,index1) in item.images.slice(0,3)" :key="index1" class="p-r">
                    <div>
                      <img :src="item1" alt style="width:300px;height:200px;" />
                    </div>
                  </div>
                </div>
                <div class="m-t-2 f-c-hei p-r">
