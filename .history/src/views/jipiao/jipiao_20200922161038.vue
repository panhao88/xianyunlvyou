    ...
    <div class="box1">
      <div class="box2">
        <div style="width:1050px;">
          ...
          <div class="m-t-2">
            <div class="b-r" v-for="(item,index) in flights.slice((current-1)*pageSize,current*pageSize)" :key="index" style="margin-top:8px">
              <div class="d-f a-c j-c-a">
                <div style="width:25%;">{{item.airline_name}}{{item.flight_no}}</div>
                <div style="width:50%" class="d-f j-c-b">
                ...
                <div style="width:25%;">
                  <div v-for="(item1,index1) in item.seat_infos.splice(0,1)" :key="index1">
                  <div class="d-f a-c">
                    <span>￥</span>
                    <span style="color:orange;font-size: 30px;">810</span>
                     <span>起</span>
                  </div>
                </div>
                </div>
