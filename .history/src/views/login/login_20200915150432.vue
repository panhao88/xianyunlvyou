<template>
  <div class="box1">
    ...
    <div class="box2">
      ...
      <div v-if="didi === 0">
        <div>
          <a-input v-model:value="value" placeholder="Basic usage" size="large" style="width: 400px"/>
        </div>
        <div>
          <a-input-password v-model:value="value" placeholder="input password" size="large" style="width: 400px" />
        </div>
        <div>忘记密码</div>
        <div>
