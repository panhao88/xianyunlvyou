      ...
      <div class="box2">
        ...
        <div class="bot1">
          ...
          <div class="boto">
            <div>
              <div
                v-for="(item,index) in posts.slice((current-1)*pageSize, current*pageSize)"
                :key="index"
              >
                <div class="bott"></div>
                <div :class="item.images.length===1? 'didi1':''">
                  <!-- <div :class="item.images.length===1? 'didi2':''"> -->
                    <div
                      class="f-s-2 f-c-hei"
                      @click="goto(item)"
                  ...
                  <!-- </div> -->
                  <div v-if="item.images.length" :class="item.images.length === 2 ? 'php':'pop'">
                    <div v-for="(item1,index1) in item.images.slice(0,3)" :key="index1">
                      <div>
                        <img
                          :src="item1"
                          alt
                          style="flex:1;width:300px;height:200px; padding:20px;"
                          @click="goto(item)"
                        />
                      </div>
                    </div>
