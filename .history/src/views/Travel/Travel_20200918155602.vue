          ...
          <div class="boto">
            ...
            <div>
              <div v-for="(item,index) in posts" :key="index">
                ...
                <div class="d-f p-2 ">
                  <div v-for="(item1,index1) in item.images.slice(0)" :key="index1">
                  <div>
                    <img :src="item1" alt style="width:300px;height:200px;" v-if="item.images.length >= 0&&item.images.length < 4" />
                  </div>
                </div>
                </div>
              </div>
