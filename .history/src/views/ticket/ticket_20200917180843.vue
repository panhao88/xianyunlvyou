        ...
        <div class="box3">
          <div class="box3a">
            ...
            <div class="d-f a-c j-c-a f-d-c" style="width:100%;height:400px">
              <div class="d-f" >
                出发城市：
                <a-input v-model:value="value" placeholder="Basic usage" style="width:300px;height:100px" size="large"/>
              </div>
              <div class="d-f">
                到达城市:
                <a-input v-model:value="value" placeholder="Basic usage" style="width:300px"/>
              </div>
              <div>
